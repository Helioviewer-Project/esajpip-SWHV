...
namespace log4cpp {
    ...
    class LOG4CPP_EXPORT Category {
      ...
      protected:
        ...
        virtual void _logUnconditionally(Priority::Value priority, const char* format,
      ...
      private:
        ...
        virtual bool ownsAppender(Appender* appender, OwnsAppenderMap::iterator& i2) LOG4CPP_NOTHROW;
