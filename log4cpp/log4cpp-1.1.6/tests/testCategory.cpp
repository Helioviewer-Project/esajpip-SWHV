...
void testGetAppender(log4cpp::Category& category, log4cpp::Appender* appender, log4cpp::Appender* appender2,
    ...
    if ((tmpAppender == appender) || (tmpAppender == appender2) || (tmpAppender == &appender3)) {
...
void testMultiAppenders() {
    ...
    log4cpp::Appender* appender2 = new log4cpp::OstreamAppender("appender2", &std::cout);
...
int main(int argc, char** argv) {
    ...
    log4cpp::Appender* appender2 = new log4cpp::OstreamAppender("default2", &std::cout);
    ...
    char lengthy1[] =
        ...
        "variable-arguments lists overflow. Test for variable-arguments lists overflow. Test for variable-arguments "
        "lists overflow. Test for variable-arguments lists overflow. Test for variable-arguments lists overflow. Test "
        "for variable-arguments lists overflow. Test for variable-arguments lists overflow. Test for "
        "variable-arguments lists overflow. Test for variable-arguments lists overflow. Test for variable-arguments "
        "lists overflow. Test for variable-arguments lists overflow. Test for variable-arguments lists overflow. Test "
        "for variable-arguments lists overflow. Test for variable-arguments lists overflow. Test for "
        "variable-arguments lists overflow. Test for variable-arguments lists overflow. Test for variable-arguments "
        ...
        "variable-arguments lists overflow. Test for variable-arguments lists overflow. Test for variable-arguments "
        "lists overflow. ";
    testLogva(root, log4cpp::Priority::ERROR,
              "This contains really lengthy strings which should be logged well (%d bytes): %s", sizeof(lengthy1),
              lengthy1);
